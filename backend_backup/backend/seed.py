# (¡Cuidado! Aquí sobreescribimos seed.py, primero verifica su contenido actual)
# Si tu seed.py ya tiene datos valiosos, mejor editarlo manualmente. Pero si no, pega esto:
import asyncio
